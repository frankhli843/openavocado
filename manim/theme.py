"""
AvocadoCore Manim theme — 3Blue1Brown-style visual system for lesson videos.

Design intent (see knowledge/projects/avocadocore_dev.md → "Manim video lesson
pipeline"): the AvocadoCore site is light-themed (white bg, accent blue #3B82F6,
success emerald #10b981, warning amber #f59e0b, danger red #ef4444, text
#111827). 3Blue1Brown-style videos read best on a dark stage, so we render on a
refined dark slate background and reuse the *site's accent hues* for highlights
...
# Background: a dark slate rather than pure black — softer, less banding.
BG = "#0F1117"
...
# Semantic role → color (used by scenes for Q/K/V, residual, etc.)
ROLE_QUERY = ACCENT
ROLE_KEY = AMBER
ROLE_VALUE = EMERALD
...
# ─── Fonts ──────────────────────────────────────────────────────────────────
# Manim renders MathTex via LaTeX (Computer Modern) — crisp and 3b1b-native.
