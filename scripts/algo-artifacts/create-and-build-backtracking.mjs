// Create + build the Backtracking bespoke visual artifacts against the live demo service.
...
const ARTIFACTS = [
  { slug: "algo-backtracking-overview-map", title: "Backtracking — Pattern Orientation Map", file: "algo-backtracking-overview-map.tsx" },
  { slug: "algo-backtracking-tree", title: "Backtracking — Subsets Decision Tree (choose/explore/un-choose)", file: "algo-backtracking-tree.tsx" },
  { slug: "algo-backtracking-permutations", title: "Backtracking — Permutations with a used-array", file: "algo-backtracking-permutations.tsx" },
];
