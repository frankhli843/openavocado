// Create + build the Mixed Hard bespoke visual artifacts against the live demo service.
// Idempotent: PATCH+rebuild if the slug already exists. Mirror of create-and-build-binsearch.mjs.
import fs from "fs";
...
const ARTIFACTS = [
  { slug: "algo-mixedhard-recognition", title: "Mixed Hard — Pattern Recognition Dashboard (three unlabeled problems with reveal)", file: "algo-mixedhard-recognition.tsx" },
  { slug: "algo-mixedhard-slidingwindow", title: "Mixed Hard — Sliding Window for Minimum Window Substring (expand-shrink loop)", file: "algo-mixedhard-slidingwindow.tsx" },
  { slug: "algo-mixedhard-backtrack", title: "Mixed Hard — Backtracking for Palindrome Partitioning (decision tree)", file: "algo-mixedhard-backtrack.tsx" },
];
