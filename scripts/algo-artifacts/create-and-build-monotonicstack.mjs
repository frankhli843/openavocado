// Create + build the Monotonic Stack bespoke visual artifacts against the live demo service.
...
const ARTIFACTS = [
  { slug: "algo-monotonic-overview-map", title: "Monotonic Stack — Pattern Orientation Map", file: "algo-monotonic-overview-map.tsx" },
  { slug: "algo-monotonic-nge", title: "Monotonic Stack — Next Greater Element (decreasing stack)", file: "algo-monotonic-nge.tsx" },
  { slug: "algo-monotonic-histogram", title: "Monotonic Stack — Largest Rectangle (increasing stack + sentinel)", file: "algo-monotonic-histogram.tsx" },
];
