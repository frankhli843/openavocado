// Create + build the Trie bespoke visual artifacts against the live demo service.
...
const ARTIFACTS = [
  { slug: "algo-trie-overview-map", title: "Trie — Pattern Orientation Map", file: "algo-trie-overview-map.tsx" },
  { slug: "algo-trie-structure", title: "Trie — Insert / Search + End-of-Word Flag", file: "algo-trie-structure.tsx" },
  { slug: "algo-trie-prefix", title: "Trie — Autocomplete (walk prefix, DFS collect)", file: "algo-trie-prefix.tsx" },
];
