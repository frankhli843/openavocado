// Rescale lesson 20 (Trie) synced-visual cues + duration_hint to the REAL
// generated audio durations (from generated_artifacts), then the lesson-part
// synced visuals re-validate. Idempotent: rescales relative to the stored
// duration_hint. Mirror of rescale-heap-cues.mjs for lesson 20.
