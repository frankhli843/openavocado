...
#
# Outputs (under the live tree via AVOCADOCORE_RUNTIME_ROOT):
...
RUNTIME_ROOT="${AVOCADOCORE_RUNTIME_ROOT:-$LIVE_DEFAULT}"
...
OUT_DIR="$RUNTIME_ROOT/runtime_artifacts/videos/lesson_${LESSON}"
...
AUDIO_ABS="$RUNTIME_ROOT/$AUDIO_REL"
