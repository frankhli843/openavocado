...
<section class="mission">
  ...
  <p>Open Avocado continues a mission that began in 2019 as <strong>AVO</strong>, a student-built
  adaptive learning platform founded on a simple belief: <em>with the right learning strategy and
  personalized tutoring, no one should ever have to struggle with learning.</em></p>
  <p>AVO set out to fix three problems in education — an inefficient, one-size-fits-all approach; a
  ...
  complementing teachers and open textbooks rather than replacing them.</p>
