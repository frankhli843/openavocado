...
<section class="hero">
  ...
  <p class="eyebrow">Empower human learning</p>
  <h1><span class="b-open">Open</span><span class="b-avo"> Avocado</span></h1>
  <p class="tagline">A free, open-source adaptive learning platform powered by AI. Set a goal, and it keeps
  ...
  <p class="hero-liveline">Live public site: <a href="{PAGES}">{PAGES}</a></p>
</section>

<section id="demo">
  <div class="video-wrap">
    <video controls preload="none" poster="assets/media/showcase-poster.jpg"
      aria-label="Open Avocado feature walkthrough with voiceover: subjects and mastery, lesson orientation, interactive visualizations, adaptive quizzes, progress, the three ways to run it (a local LLM, your own API key, or an agent harness), a side-by-side audio-synced lesson video, and how to try the live demo">
  ...
  mastery, interactive visualizations, adaptive quizzes, and progress; the three ways to run it (a local LLM for
  privacy, your own API key for the fastest start, or an agent harness for richer generation); and a side-by-side
  audio-synced lesson video the platform generates, ending with how to try the live demo.</p>
</section>

<section class="mission">
  <p class="eyebrow">Our mission</p>
  <h2 class="mission-title">Empower human learning — for everyone, freely.</h2>
  <p>Open Avocado continues a mission that began in 2017 as <strong>AvocadoCore</strong> (also known as
  AVO), a student-built adaptive learning platform founded on a simple belief: <em>with the right learning
  strategy and personalized tutoring, no one should ever have to struggle with learning.</em></p>
  <p>It set out to fix three problems in education — an inefficient, one-size-fits-all approach; a
  lack of personalized attention; and the unequal distribution of educational resources. It
  customized each learner's plan, gave instant feedback, and taught exactly what they needed next,
  complementing teachers and open textbooks rather than replacing them. AVO later took part in a
  2019 Western Accelerator cohort, which produced its accelerator-era pitch and public materials.</p>
  <p>The AI era finally makes that mission reachable for everyone. <strong>Open Avocado is the
  open-source, free continuation of that idea</strong> — modern AI in place of scarce human tutors,
  and a platform anyone, anywhere can run, extend, and learn from.</p>
</section>

<section>
  <div class="sec-head">
    <h2>How the adaptive loop works</h2>
    <p>Most courses are a fixed list of lessons for an average student. Open Avocado treats learning as a
    loop driven by evidence — so the next lesson is always the one you need.</p>
  </div>
  <div class="loop">
    <div class="step"><div class="n">1</div><h3>Define the goal</h3><p>Name a subject and what you want to be able to do. Open Avocado runs an initial assessment to map where you stand.</p></div>
    <div class="step"><div class="n">2</div><h3>Keep the evidence</h3><p>Every answer, code submission, quiz result, and diagnostic becomes a durable <strong>mastery signal</strong>.</p></div>
    <div class="step"><div class="n">3</div><h3>Generate the next lesson</h3><p>An AI lesson generator reads the evidence and authors the single next lesson that closes the biggest gap with the least effort.</p></div>
    <div class="step"><div class="n">4</div><h3>Grow to mastery</h3><p>You move from <strong>familiarity</strong> to <strong>competence</strong> to <strong>mastery</strong> — and the loop repeats.</p></div>
  </div>
  <div class="split">
    <figure class="shot-real split-media">
      <img src="assets/shots/mastery.png" alt="Open Avocado mastery view showing the familiarity, competence, mastery, and post-mastery phases with a 96 percent mastery score and strengths, review-needed, and weak-spot tags." loading="lazy">
      <figcaption><strong>Mastery view</strong> — phase progression and an evidence-based mastery score with strengths and weak spots.</figcaption>
    </figure>
    <div class="split-copy">
      <h3>Progress you can see and trust</h3>
      <p>Open Avocado holds a phase for a subject until it has enough evidence to advance. It shows exactly
      what it is waiting on — completed lessons, assessed answers, code submissions — so progress is never a
      mystery number.</p>
      <p>Per-subject mastery scores, tags, and difficulty are visible to the learner <em>and</em> fed back
      into what gets generated next.</p>
    </div>
  </div>
</section>
...
<section>
  <div class="sec-head">
    <h2>See a lesson come to life</h2>
    <p>Every lesson is a full workspace: a knowledge-graph orientation, narrated walkthrough, bespoke
    interactive visualizations, browser-run code, and adaptive quizzes — all real screenshots below.</p>
  </div>
  <div class="gallery">
    <figure class="shot-real">
      <img src="assets/shots/viz-attention.png" alt="Interactive Attention Score Calculator widget: pick a query token to see Q, K, V vectors and step through raw scores, scaling, softmax, and the weighted sum." loading="lazy">
      <figcaption><strong>Interactive visualization</strong> — a bespoke attention-score calculator you can step through.</figcaption>
    </figure>
    <figure class="shot-real">
      <img src="assets/shots/quiz.png" alt="Adaptive quiz showing select-one and select-all questions tagged by difficulty, each with a Check answer button." loading="lazy">
      <figcaption><strong>Adaptive quiz</strong> — select-one, select-all, and written questions with instant grading.</figcaption>
    </figure>
    <figure class="shot-real">
      <img src="assets/shots/code-exercise.png" alt="Scaffolded coding exercise with a task, constraints, worked walkthrough, input/output examples, and a browser-run Python editor with Run tests and Submit buttons." loading="lazy">
      <figcaption><strong>Scaffolded code</strong> — browser-run Python (Pyodide) with hints, examples, and hidden tests.</figcaption>
    </figure>
    <figure class="shot-real">
      <img src="assets/shots/viz-trie.png" alt="Interactive trie visualization stepping through inserting the word car, with an end-of-word flag and Prev/Next controls." loading="lazy">
      <figcaption><strong>Step-through diagrams</strong> — algorithms and data structures you can drive one step at a time.</figcaption>
    </figure>
    <figure class="shot-real">
      <img src="assets/shots/concept-map.png" alt="Concept map for a transformer block showing token embedding at the center connected to Q/K/V, attention, softmax, MLP, LayerNorm, and the residual stream." loading="lazy">
      <figcaption><strong>Knowledge-graph orientation</strong> — every lesson opens by showing where it sits in the subject.</figcaption>
    </figure>
    <figure class="shot-real">
      <img src="assets/shots/interactive-slider.png" alt="Interactive sliding-window widget: drag a size-three window across an array while the running sum and best-sum-so-far update." loading="lazy">
      <figcaption><strong>Live manipulables</strong> — drag, slide, and watch the numbers update as you explore.</figcaption>
    </figure>
  </div>
  <div class="split rev">
    <figure class="shot-real split-media">
      <img src="assets/shots/dashboard.png" alt="Open Avocado learner dashboard listing subjects such as Coding Interview Mastery and Model Building and Inference, each with a mastery percentage and progress bar." loading="lazy">
      <figcaption><strong>Learner dashboard</strong> — subjects, mastery, and progress at a glance.</figcaption>
    </figure>
    <div class="split-copy">
      <h3>A calm home for everything you're learning</h3>
      <p>Track multiple subjects side by side, each with its own mastery score, phase, and lesson progress.
      Open a subject to see its lessons, mastery breakdown, goals, and the AI's planning work.</p>
      <p>Everything is responsive, so the full lesson workspace — audio, interactives, code, and quizzes —
      works on a phone as well as a desktop.</p>
    </div>
  </div>
  <div class="gallery">
    <figure class="shot-real">
      <img src="assets/shots/mobile-dashboard.png" alt="Open Avocado dashboard on a 390 pixel wide mobile screen with stacked subject cards." loading="lazy">
      <figcaption><strong>Mobile (390px)</strong> — the dashboard, responsive.</figcaption>
    </figure>
    <figure class="shot-real">
      <img src="assets/shots/mobile-lesson.png" alt="An Open Avocado lesson on a 390 pixel wide mobile screen showing the lesson header, goals, and concept map." loading="lazy">
      <figcaption><strong>Mobile (390px)</strong> — the lesson workspace, responsive.</figcaption>
    </figure>
  </div>
</section>
...
<section>
  <div class="sec-head">
    <h2>What every lesson contains</h2>
    <p>Not slides. A full, multimodal workspace built for the concept in front of you.</p>
  </div>
  <div class="feature">
...
<section class="os-band">
  ...
  <h2>Built in the open, free to run</h2>
  <p>Open Avocado is free and open source. Run it on your own machine, read every line, swap the model
  runtime, and extend the lesson generator — no lock-in, no paywall between a learner and the next lesson.</p>
  <div class="os-values">
    <div class="v"><h3>Free &amp; open</h3><p>MIT-spirited, self-hostable, and transparent end to end.</p></div>
    <div class="v"><h3>Local-first &amp; private</h3><p>Your data stays in a local SQLite database. Provider keys are encrypted and never sent to the browser.</p></div>
    <div class="v"><h3>Pluggable runtimes</h3><p>A tiny adapter interface lets a cloud key, a local model, or an agent runtime drive generation.</p></div>
    <div class="v"><h3>Contribution-friendly</h3><p>Clear docs, a public-readiness audit, and a separate-QA authoring model make it easy to help.</p></div>
  </div>
</section>
...
<section>
  <div class="sec-head">
    <h2>Who it's for</h2>
    <p>One evidence-driven engine, useful from your first hour to your hardest problem set.</p>
  </div>
  <div class="aud-grid">
    <div class="aud"><h3>Self-directed learners</h3><p>Learn a subject on your own terms, with a tutor that adapts to what you actually know.</p></div>
    <div class="aud"><h3>Developers &amp; builders</h3><p>Fork it, plug in your model or agent, and build adaptive learning into your own product.</p></div>
    <div class="aud"><h3>Educators &amp; tinkerers</h3><p>Author lessons with a generic agent/skill model and a real quality bar, not one-size-fits-all content.</p></div>
    <div class="aud"><h3>Researchers</h3><p>An open, inspectable testbed for evidence-first, agent-generated, adaptive learning.</p></div>
  </div>
</section>
...
<section>
  <div class="sec-head">
    ...
    <p>Everything a new contributor or self-hoster needs, one card away.</p>
  </div>
  <div class="card-grid">
...
<section class="cta-band">
  <h2>Start learning in the open</h2>
  <p class="lead">Run Open Avocado locally in a few minutes, or read how the adaptive loop works.</p>
  <div class="btn-row">
    <a class="btn btn-primary" href="quickstart.html">Quick start</a>
    <a class="btn btn-secondary" href="run-api-key.html">Run with an API key</a>
    <a class="btn btn-ghost" href="{REPO}" target="_blank" rel="noopener">View on GitHub</a>
  </div>
</section>
"""
