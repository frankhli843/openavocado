...
import { getConfiguredCompletionAdapterName, getSubjectCreatedDispatcher } from "@/lib/adapters";
...
export async function POST(request: Request) {
  try {
    ...
    const adapterName = getConfiguredCompletionAdapterName();
    ...
    //   "dispatched" — async dispatch accepted but work happens later (e.g. webhook, agent-harness)
