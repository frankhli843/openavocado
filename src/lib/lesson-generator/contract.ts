 ...
 *
 * Implementations:
 * - External task-runner adapter: creates a next-lesson generation task
...
/** Fifteen minutes with margin at the current Edge TTS pace. */
...
export const LESSON_QUALITY_BAR_PROMPT = [
  ...
  "Before lesson work starts, read the main Open Avocado lesson-authoring skill: skills/avocadocore-lesson-authoring/SKILL.md.",
