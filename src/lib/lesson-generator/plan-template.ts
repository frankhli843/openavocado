...
export const COMPREHENSIVE_LESSON_PLAN_TEMPLATE = [
  ...
  "- Full roadmap update: at least 1,500 words for normal technical subjects, or at least 1,000 words for short non-technical subjects. If the subject goal is broad, such as building an LLM, contributing to an open-source ML project, inference, quantization, GGUF, or frontier-paper study, use at least 2,000 words.",
...
export function buildFixtureComprehensivePlan(params: {
  ...
  return [
    ...
    "",
    "Milestone D, applied real-world path. This milestone must become a 1,000+ word section in the AI harness plan. It should connect the subject to the learner's practical goal, such as contributing to an open-source ML project or understanding production model-building work. It should include real-world project workflows, release-card reading, reproducibility checks, model artifact inspection, and the difference between learning demos and production constraints. The AI should consult current official docs and project-specific references before authoring lessons here.",
    "",
