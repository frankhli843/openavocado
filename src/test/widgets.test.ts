        ...
        content: {
          ...
          orientation_visual: {
            ...
            scene: {
              ...
              motif: "test pipeline",
              description: "A generated test scene showing that the audio has a real bespoke orientation visual.",
              panels: [
                {
                  id: "pipeline",
                  title: "Pipeline",
                  kind: "pipeline",
                  description: "A simple generated panel for the test lesson.",
                  data: [
                    { label: "Input", value: "start", role: "input" },
                    { label: "Process", value: "learn", role: "process" },
                    { label: "Output", value: "ready", role: "output" },
                  ],
                },
                {
                  id: "state",
                  title: "State",
                  kind: "cards",
                  description: "A second generated panel so the scene is not a single box.",
                  data: [
                    { label: "Known", value: "context", role: "context" },
                    { label: "New", value: "concept", role: "process" },
                  ],
                },
              ],
            },
