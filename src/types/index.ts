...
export type {
  ...
  PracticeCodeVisualizationItem,
  PracticeCodeWalkthrough,
  PracticeCodeWalkthroughStep,
  PracticeCodeWorkedExample,
  MultipleChoiceQuestion,
  MultipleChoiceQuizContent,
  LessonPartPracticeQuestion,
  LessonPartPracticeContent,
 ...
 * Generic adapters (noop, local-queue, webhook, agent-harness) are available.
 * Optional compatibility adapters can map this event into another task system.
 */
